...
class getDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\Admin\\DashboardController'] = $instance = new \App\Controller\Admin\DashboardController(($container->privates['App\\Repository\\DetailsCandidatureRepository'] ?? $container->load('getDetailsCandidatureRepositoryService')), ($container->privates['App\\Repository\\ClientRepository'] ?? $container->load('getClientRepositoryService')), ($container->privates['App\\Repository\\BienRepository'] ?? $container->load('getBienRepositoryService')), ($container->privates['App\\Repository\\ProjetRepository'] ?? $container->load('getProjetRepositoryService')), ($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService')), ($container->privates['App\\Repository\\TypeDeBienRepository'] ?? $container->load('getTypeDeBienRepositoryService')), ($container->privates['App\\Repository\\InscriptionRepository'] ?? $container->load('getInscriptionRepositoryService')));

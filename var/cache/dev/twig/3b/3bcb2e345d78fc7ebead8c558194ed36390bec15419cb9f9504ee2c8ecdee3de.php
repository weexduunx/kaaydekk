...
class __TwigTemplate_99e081fb0661978e0aaa8d5909133202ff341e0e4095256421a6a0f69333ab74 extends Template
{
    private $source;
    private $macros = [];
            ...
            <li class=\"user-footer\">
                ...
                if ((isset($context["showProfileLink"]) || array_key_exists("showProfileLink", $context) ? $context["showProfileLink"] : (function () { throw new RuntimeError('Variable "showProfileLink" does not exist.', 42, $this->source); })())) {
                    ...
                    echo "                    <div class=\"pull-left\">
                        <a href=\"";
                    // line 44
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath($this->env->getRuntime('KevinPapst\AdminLTEBundle\Twig\RuntimeExtension')->getRouteByAlias("adminlte_profile"), ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 44, $this->source); })()), "identifier", [], "any", false, false, false, 44)]), "html", null, true);
                    echo "\"
...
{% endif %}
", "@AdminLTE/Navbar/user.html.twig", "/home/ngts/Kaay-Dekk-Immo/vendor/kevinpapst/adminlte-bundle/Resources/views/Navbar/user.html.twig");
    }
}

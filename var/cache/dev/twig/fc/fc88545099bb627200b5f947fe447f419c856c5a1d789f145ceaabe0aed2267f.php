...
";
    ...
    public function block_menu_item($context, array $blocks = [])
    {
        ...
        echo "
                    ...
                    ";
        // line 28
        if (twig_get_attribute($this->env, $this->source, (isset($context["menuItem"]) || array_key_exists("menuItem", $context) ? $context["menuItem"] : (function () { throw new RuntimeError('Variable "menuItem" does not exist.', 28, $this->source); })()), "hasSubItems", [], "any", false, false, false, 28)) {
            // line 29
            echo "                        <ul class=\"collapse first-level base-level-line in\" aria-expanded=\"false\" >
                            ";
            // line 30
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["menuItem"]) || array_key_exists("menuItem", $context) ? $context["menuItem"] : (function () { throw new RuntimeError('Variable "menuItem" does not exist.', 30, $this->source); })()), "subItems", [], "any", false, false, false, 30));
            $context['loop'] = [
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
    ...
    public function block_menu_subitem($context, array $blocks = [])
    {
        ...
        // line 32
        echo "                                    <li class=\"sidebar-item ";
        echo ((twig_get_attribute($this->env, $this->source, (isset($context["menuSubItem"]) || array_key_exists("menuSubItem", $context) ? $context["menuSubItem"] : (function () { throw new RuntimeError('Variable "menuSubItem" does not exist.', 32, $this->source); })()), "isMenuSection", [], "any", false, false, false, 32)) ? ("header") : (""));
        echo "
                                      ";
        // line 33
        echo ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["ea"]) || array_key_exists("ea", $context) ? $context["ea"] : (function () { throw new RuntimeError('Variable "ea" does not exist.', 33, $this->source); })()), "mainMenu", [], "any", false, false, false, 33), "isSelected", [0 => (isset($context["menuSubItem"]) || array_key_exists("menuSubItem", $context) ? $context["menuSubItem"] : (function () { throw new RuntimeError('Variable "menuSubItem" does not exist.', 33, $this->source); })())], "method", false, false, false, 33)) ? ("active") : (""));
        echo "\">
                                        <span >";
        // line 34
        echo twig_call_macro($macros["_self"], "macro_render_menu_item", [(isset($context["menuSubItem"]) || array_key_exists("menuSubItem", $context) ? $context["menuSubItem"] : (function () { throw new RuntimeError('Variable "menuSubItem" does not exist.', 34, $this->source); })())], 34, $context, $this->getSourceContext());
        echo "</span>
                                    </li>
                                ";
    ...
    {
        return array (  346 => 12,  342 => 11,  337 => 10,  331 => 9,  327 => 8,  318 => 7,  310 => 5,  303 => 4,  300 => 3,  281 => 2,  263 => 46,  250 => 34,  246 => 33,  241 => 32,  231 => 31,  220 => 40,  216 => 38,  202 => 37,  199 => 31,  182 => 30,  179 => 29,  177 => 28,  171 => 25,  165 => 24,  158 => 23,  148 => 22,  138 => 43,  124 => 42,  121 => 22,  103 => 21,  93 => 20,  75 => 16,  65 => 46,  61 => 44,  59 => 20,  54 => 17,  52 => 16,  49 => 15,);
    }
                ...
                <li class=\"sidebar-item {{ menuItem.isMenuSection ? 'header' }} {{ menuItem.hasSubItems ? 'treeview' }}
                  {{ ea.mainMenu.isSelected(menuItem) ? 'selected' }} {{ ea.mainMenu.isExpanded(menuItem) ? 'selected submenu-selected' }}\">
                    ...
                    {% if menuItem.hasSubItems %}
                        <ul class=\"collapse first-level base-level-line in\" aria-expanded=\"false\" >

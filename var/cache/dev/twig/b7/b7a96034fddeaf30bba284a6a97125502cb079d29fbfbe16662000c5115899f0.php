...
/* base.html.twig */
class __TwigTemplate_0b9d1a8121ef056b315a62c1260119dcbb540fa3fdd6a9c5dd855c19fb77a1b3 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav class=\"navbar navbar-default navbar-trans navbar-expand-lg  fixed-top navbar-trans\">
        ...
        echo "\">Accueil</a>
                                ...
                                <li class=\"nav-item\">
                                    <a class=\"nav-link ";
        // line 73
        if ((array_key_exists("current_menu", $context) && (0 === twig_compare((isset($context["current_menu"]) || array_key_exists("current_menu", $context) ? $context["current_menu"] : (function () { throw new RuntimeError('Variable "current_menu" does not exist.', 73, $this->source); })()), "properties")))) {
            echo "active";
        }
        echo "\"

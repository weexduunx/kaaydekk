...
class __TwigTemplate_c6914237cbac10c0f40ddc400385e6ffebe42cd70136a490d996dece2e0a1dbe extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            // line 29
            if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 29, $this->source); })()), "session", [], "any", false, false, false, 29), "flashbag", [], "any", false, false, false, 29), "peekAll", [], "any", false, false, false, 29)), 0))) {
                // line 30
                echo "        ";
...
{% macro session_flash(close, use_raw, class, domain) %}
    ...
    {% endif %}
{% endmacro %}
", "@AdminLTE/Macros/default.html.twig", "/home/ngts/Kaay-Dekk-Immo/vendor/kevinpapst/adminlte-bundle/Resources/views/Macros/default.html.twig");
    }
}

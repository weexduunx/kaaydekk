...
/* base.html.twig */
class __TwigTemplate_34c5e2bd7cbf21d532cb2ba1e177b38aadd00db3ce17209646449e3a1081d1ff extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav class=\"navbar navbar-default navbar-trans navbar-expand-lg  fixed-top navbar-trans\">
        ...
        echo "\">Accueil</a>
                                ...
                                <li class=\"nav-item\">
                                    <a class=\"nav-link ";
        // line 73
        if ((array_key_exists("current_menu", $context) && (0 === twig_compare(($context["current_menu"] ?? null), "properties")))) {
            echo "active";
        }
        echo "\"

...
use App\Repository\Details2Repository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=Details2Repository::class)
 */
class Details2
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=DetailsCandidature::class, mappedBy="logement_actuel")
     */
    ...
    public function addDetailsCandidature(DetailsCandidature $detailsCandidature): self
    {
        if (!$this->detailsCandidatures->contains($detailsCandidature)) {
            ...
            $detailsCandidature->setLogementActuel($this);
        }
    ...
    public function removeDetailsCandidature(DetailsCandidature $detailsCandidature): self
    {
        if ($this->detailsCandidatures->removeElement($detailsCandidature)) {
            ...
            if ($detailsCandidature->getLogementActuel() === $this) {
                $detailsCandidature->setLogementActuel(null);
            }
        }
